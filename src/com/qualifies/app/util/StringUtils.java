...
public class StringUtils {
	...
	/**
	 * return double of input string value (can input format is "2,000" ) ֱ�ӽ�ȡ�̶�С��λ,δ��������
	 * @param s
	 * @return
	 */
	...
	/**
	 * ��String ����ת��Ϊboolean����,����"true" ,"false" , "0" , "1","Y","N","YES","NO"������,������ʽΪfalse����
	 * @param str
	 * @return
	 */
	...
	/**
	 * ��boolean����ת��ΪString �������,��ʽ��"0","1","Y","N","T","F"������,Ĭ��ʹ��"0","1"
	 * @param str
	 * @return
	 */
...
*/
	...
	public static boolean getValidIdentityNo ( String xidentityno ){
		if(xidentityno.length()!=18){
			throw new IllegalArgumentException("���֤���Ȳ���");
		}
		...
		for(int i=1;i<=17;i++){
			...
			if(b<48 || b>57) {
				throw new IllegalArgumentException("���֤�������Ϊ����");
			}
		...
		if(!idno.equals(xidentityno)){
			throw new IllegalArgumentException("���֤���벻��!");
		}		
		return true;
	}
	
	/**
	 * ��֤���֤����getValidIdentityNo �����������𣺸��ݴ������ͷ��ز�ͬ��ֵ��������ֱ���׳�����
	 * @param xidentityno
	 * @return
	 * @version 1.1 habe
	 */
	...
	/**
	 * �ж�sourceStr �Ƿ���� patern����.
	 * ����:  �ж��Ƿ�������Ƿ�ֻ�����ֺ���ĸ pattern = /[A-Za-z0-9]/
	 * @param pattern
	 * @param sourceStr
	 * @return
	 */
	...
	/**
	 * ��ȡ�ض�������, ���޶����е����ݣ��򷵻ؽ���
	 * LAST_MONTHN_FIRST_DATE = ��һ��������
	 * LAST_MONTHN_LAST_DATE = ��һ�������һ��
	 * @param defined
	 * @return
	 */
	public static Date getDateByDefine(String define){
		...
		if (define.equalsIgnoreCase("LAST_MONTHN_FIRST_DATE")){
			c.set(Calendar.DATE,1); // ��������µĵ�һ��.
			date = modifyDate(c.getTime(),0,-1,0,0,0,0); // ��һ��������
		} else if (define.equalsIgnoreCase("LAST_MONTHN_LAST_DATE")){
			c.set(Calendar.DATE,1); // ��������µĵ�һ��.
			date = modifyDate(c.getTime(),0,0,-1,0,0,0); // ��һ�������һ��
		} else if (define.equalsIgnoreCase("LAST_LAST_WEEK_SATURDAY_DATE")) {
			int dayofweek = c.get(Calendar.DAY_OF_WEEK);
			date = modifyDate(c.getTime(),0,0,- (dayofweek + 7)  ,0,0,0);//���ϸ�������
		} else if (define.equalsIgnoreCase("LAST_WEEK_FRIDAY_DATE")) {
			int dayofweek = c.get(Calendar.DAY_OF_WEEK);
			date = modifyDate(c.getTime(),0,0,- (dayofweek + 1)  ,0,0,0);//�ϸ�������
		} else if (define.equalsIgnoreCase("LAST_DATE")){
			date = modifyDate(c.getTime(),0,0,-1,0,0,0); //����
		}
